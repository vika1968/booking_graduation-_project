  ...
  const handleClick = async (e: FormEvent) => {
    ...
    try {
     ...
     inputs.forEach((input) => {     
      if (
        (input.id === info.email && (info.email === undefined || info.email.trim()===''))  || 
       (input.id === info.city && ( info.city === undefined || info.city.trim()==='')) || 
       (input.id === info.country && ( info.country === undefined || info.country.trim()==='')) || 
       (input.id === info.password && ( info.password === undefined || info.password.trim()==='')) || 
       (input.id === info.phone && ( info.phone === undefined || info.phone.trim()==='')) || 
       (input.id === info.username && ( info.username === undefined || info.username.trim()===''))  
      )   
      {
        isValid = false;  
      }
